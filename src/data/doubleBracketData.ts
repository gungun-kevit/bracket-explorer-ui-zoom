...
import { DoubleBracket } from "@/types/bracket";
import { generateDoubleBracketNodesAndEdges } from "@/utils/bracketUtils";

export const doubleEliminationData: DoubleBracket = {
  upper: [
    {
      id: 20512,
      name: 'UB Semi Final',
...
// Generate nodes and edges from the double elimination tournament data
const { nodes: initialDoubleNodes, edges: initialDoubleEdges } = generateDoubleBracketNodesAndEdges(doubleEliminationData);

export { initialDoubleNodes, initialDoubleEdges };
